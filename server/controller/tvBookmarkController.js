...
const TvModel = require('../model/tvModel.js');
...
const addBookmark = async (req, res) => {
  try {
    ...
    const newBookmark = new TvModel(req.body);
...
const removeBookmark = async (req, res) => {
    ...
    try {
        const result = await TvModel.deleteOne({ email, id });
...
const getAllBookmarkByEmail = async (req, res) => {
    ...
    try {
        const bookmarks = await TvModel.find({ email });
