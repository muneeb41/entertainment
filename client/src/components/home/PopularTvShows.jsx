...
const PopularTvShows = () => {
  ...
  useEffect(() => {
    const fetchMultiplePages = async () => {
      ...
      for (let page = 1; page <= totalPages; page++) {
        requests.push(axios.get(`https://api.themoviedb.org/3/tv/popular?api_key=${apiKey}&page=${page}`));
      }
  ...
  return (
    <div className='bg-white dark:bg-gray-700'>
        <h2 className='text-xl font-bold ml-3 py-5 dark:text-white lg:text-3xl lg:ml-6 lg:pb-8 '>Popular Tv Shows</h2>
         <div>
              <SwiperWraper>
                  {
