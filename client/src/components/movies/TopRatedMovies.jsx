...
const TopRatedMovies = () => {
  ...
  useEffect(() => {
    const fetchMultiplePages = async () => {
      ...
      for (let page = 1; page <= totalPages; page++) {
        requests.push(axios.get(`https://api.themoviedb.org/3/movie/top_rated?api_key=${apiKey}&page=${page}`));
      }
  ...
  return (
    ...
    <h2 className='text-xl font-bold ml-3 py-5 dark:text-white lg:text-3xl lg:ml-6 lg:pb-8  animate-slide-from-left'>Top Rated Movies</h2>
     <div>
          <SwiperWraper>
              {
